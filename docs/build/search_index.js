...

{
    ...
    "category": "Type",
    "text": "    PDDoc\n\nA in memory representation of a PDF document. Once created this type has to be used to access a PDF document.\n\n\n\n"
},
...

{
    ...
    "category": "Function",
    "text": "    pdDocGetCatalog(doc::PDDoc) -> CosObject\n\nCatalog is considered the topmost level object in  PDF document that is subsequently used to traverse and extract information on a PDF document. To be used for accessing PDF internal objects from document structure when no direct API is available.\n\n\n\n"
},

{
    ...
    "category": "Function",
    "text": "    pdDocGetNamesDict(doc::PDDoc) -> CosObject\n\nSome information in PDF is stored as name and value pairs not essentially a dictionary. They are all aggregated and can be accessed from one names dictionary object in the document catalog. This method provides access to such dictionary in a PDF file. Not all PDF document may have a names dictionary. In such cases, a CosNull object may be returned.\n\n\n\n"
},

{
    ...
    "category": "Function",
    "text": "    pdDocGetInfo(doc::PDDoc) -> Dict\n\nGiven a PDF document provides the document information available in the DocumentInfo disctionary. The information typically includes _creation date, modification date, author, creator_ used etc. However, information content are not all mandatory and all information may not be available in a document. Please refer to the PDF specification for details.\n\n\n\n"
},
...

{
    ...
    "category": "Function",
    "text": "    pdPageGetContentObjects(page::PDPage) -> CosObject\n\nA page object can have multiple associated content objects. This method will return a CosArray if there are multiple of content objects associated. Otherwise an indirect object of CosStream type will be returned.\n\n\n\n"
},
...

{
    ...
    "category": "Function",
    "text": "    cosDocGetRoot(doc::CosDoc) -> CosDoc\n\nThe structural starting point of a PDF document. Also known as document root dictionary. This provides details object locations and document access methodology. This should not be confused with the catalog object of the PDF document.\n\n\n\n"
},
...

{
    ...
    "category": "Function",
    "text": "cosDocGetPageNumbers(doc::CosDoc, catalog::CosObject, label::AbstractString) -> Range{Int}\n\nPDF utilizes two pagination schemes. An internal global page number that is maintained serially as an integer and PageLabel that is shown by the viewers. Given a label this method returns a range of valid page numbers for the given label. \n\n\n\n"
},
